...
def main() -> int:
    ...
    try:
        ...
        if dt > 20:
            ...
            print("velocity budget. Failing takes longer than succeeding, which")
            print("is why the gateway needs a timeout shorter than its budget")
            print("rather than relying on the client's default.")
